    ...
    <section id="container">
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <p class="centered"><a href="profile.html"><img src="<?=ASSETS . THEME ?>admin/img/ui-sam.jpg" class="img-circle"
                                width="60"></a></p>
      ...
      *********************************************************************************************************************************************************** -->
                    ...
                    <div class="col-lg-3 ds">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?=ASSETS . THEME ?>admin/img/ui-divya.jpg" width="35px" height="35px"
                                    align="">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?=ASSETS . THEME ?>admin/img/ui-sherman.jpg" width="35px" height="35px"
                                    align="">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?=ASSETS . THEME ?>admin/img/ui-danro.jpg" width="35px" height="35px"
                                    align="">
                            </div>
                            <div class="details">
